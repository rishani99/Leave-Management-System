...
public class EmployeeSignUpUI extends JFrame {

    private JTextField nameField, emailField;
    private JPasswordField passwordField;

    public EmployeeSignUpUI() {
        ...
        // Title
        JLabel title = new JLabel("Employee Sign Up");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new EmployeeSignUpUI());
    }
}
